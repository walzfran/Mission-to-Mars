...
# 1. Use broswer to visit the URL
...
# 3. Write code to retreive the image urls and titles for each hemisphere.
...
for hemis in range(4):
    ...
    hemispheres = {}
    hemispheres['img_url'] = f'https://https://marshemispheres.com/{img_url}'
